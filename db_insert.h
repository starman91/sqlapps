...
/// Main Class for pushing data into the DB wheter new or updated data and also arrays
class DBInsert
{
	public:
		DBInsert();
		~DBInsert();
		bool sacrificeToDB (QSqlDatabase&, const QString, const QStringList, const QStringList);
		bool sacrificeToDB (QSqlDatabase&, const QString, const QStringList, const QStringList, const QString, int&);
		bool massSacrificeToDB (QSqlDatabase&, const QString, const QStringList, const int, const std::vector<double>);

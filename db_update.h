...
/// Class for updating data elements within the DB
class DBUpdate
{
	public:
		DBUpdate();
		~DBUpdate();
		bool updateToDB (QSqlDatabase&, const QString, const QStringList, const QStringList, const QStringList, const QStringList);
